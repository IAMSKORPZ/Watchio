...
class IptvController extends ChangeNotifier {
  ...
  final ImportCancellationToken _cancellationToken = ImportCancellationToken();
  ImportProgressModel? _importProgress;
  ...
  ImportProgressModel? get importProgress => _importProgress;

  void cancelImport() {
    _cancellationToken.cancel();
  }

  void _setImportProgress(ImportProgressModel progress) {
